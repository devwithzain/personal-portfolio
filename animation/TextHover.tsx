...
export default function TextHover({
	...
	return (
		<div className="group flex gap-x-[20rem] overflow-hidden cursor-pointer transition-all ease-in-out duration-200">
			<div className="relative transition-all  ease-in-out duration-500">
				<div className="">
					<h1 className="text-[40rem] translate-y-[-100%] group-hover:translate-y-[0%] absolute  left-0 transition-all ease-in-out duration-500 flex">
